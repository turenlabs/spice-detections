...
Current packs focus on concrete supply-chain incidents with published indicators, including Miasma/Hades Mini Shai-Hulud (npm and PyPI), TrapDoor, Laravel Lang, Shai-Hulud/Mini Shai-Hulud, node-ipc, and axios.
