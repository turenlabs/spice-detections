...
Current packs focus on concrete supply-chain incidents with published indicators, including Miasma (Red Hat npm), TrapDoor, Laravel Lang, Shai-Hulud/Mini Shai-Hulud, node-ipc, and axios.
